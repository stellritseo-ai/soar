...
import { useSetting, type HeroSettings, type ContactSettings } from "@/lib/cms";
...
export function HeroManager() {
  ...
  return (
    <div>
      <h2 className="font-display text-2xl">Hero & Homepage Copy</h2>
      <div className="mt-6 grid gap-4 max-w-2xl">
        ...
        <div className="flex items-center gap-3">
          <button onClick={() => save.mutate(form)} disabled={save.isPending}
            className="inline-flex items-center gap-2 rounded-full gradient-brand px-5 py-2.5 text-sm font-semibold text-primary-foreground disabled:opacity-50">
